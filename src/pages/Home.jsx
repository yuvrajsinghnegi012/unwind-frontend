    ...
    <div>
      ...
      <section className={`relative min-h-screen bg-cover bg-center bg-[url("../assets/home.jpg")]`}>
        ...
        <div className="container mx-auto flex items-center justify-center h-full">
          <h1 className="text-[2.4rem] font-bold mt-4 text-white text-center">
      ...
      <section className="flex flex-col justify-center mt-24 gap-8 items-center w-[80%] mx-auto">
        ...
        <p className="text-lg text-center px-[16rem] font-medium">Explore our wide range of vacation rentals that cater to all types of travelers. Immerse yourself in the local culture, enjoy the comforts of home, and create unforgettable memories in your dream destination.<br /></p>
      ...
      <section className="flex flex-col justify-center mt-16 gap-8 w-[90%] mx-auto">
        ...
        <div className="flex justify-center items-center flex-wrap">
          {categories.map((item, id) => (
            <div
              key={id}
              className="w-36 h-32 flex flex-col items-center justify-center p-3 cursor-pointer transition-transform transform hover:scale-110 hover:rotate-2 group"
              onClick={() => navigate(`category/${item.label}`)}
            >
      ...
      <section className="mt-16 w-[90%] mx-auto">
        ...
        <Link to={"/properties"} className="text-right text-orange-600 w-full inline-block font-medium transition-all hover:text-orange-800">
